...
@Component({
  ...
  template: `
    <section id="about" class="relative pt-36 pb-0 md:pt-48 bg-slate-900 text-white overflow-hidden">
      ...
      <!-- Certificates Banner -->
      <div class="relative z-10 border-t border-slate-800/80 bg-slate-900/50 backdrop-blur-sm">
        <div class="max-w-7xl mx-auto px-6 py-12">
          <p class="text-center text-sm font-bold text-slate-400 uppercase tracking-widest mb-10">Certifications & Credentials</p>
          ...
          <div class="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            ...
            <img 
              ...
              alt="Certification 1" 
              (click)="openCertificate('assets/cert1.jpg')"
              class="h-48 md:h-64 w-auto object-contain rounded-md shadow-[0_0_15px_rgba(0,0,0,0.3)] border border-slate-700 hover:scale-[1.15] hover:z-20 relative transition-transform duration-300 cursor-pointer"
            />
    ...
    <div *ngIf="selectedCert()" class="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/95 backdrop-blur-md p-4" (click)="closeCertificate()">
      
      <!-- Close Button -->
      <button (click)="closeCertificate()" class="absolute top-4 right-4 md:top-8 md:right-8 text-slate-400 hover:text-white transition z-50 bg-slate-900/50 p-2 rounded-full">
...
export class HeroComponent {
  // Signal to store which certificate is currently clicked
